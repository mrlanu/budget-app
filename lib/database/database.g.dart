...
class $DebtsTable extends Debts with TableInfo<$DebtsTable, Debt> {
  ...
  static const VerificationMeta _startBalanceMeta = const VerificationMeta(
    'startBalance',
  );
  @override
  ...
  static const VerificationMeta _nextPaymentDueMeta = const VerificationMeta(
    'nextPaymentDue',
  );
  @override
  ...
  Debt map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Debt(
      ...
      startBalance: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}start_balance'],
      )!,
      ...
      nextPaymentDue: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}next_payment_due'],
      )!,
    );
  }
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<$AccountsTable, List<Account>> _accountsRefsTable(
    ...
    db.accounts,
    aliasName: $_aliasNameGenerator(db.categories.id, db.accounts.categoryId),
  );
...
final class $$AccountsTableReferences
  ...
  static MultiTypedResultKey<$TransactionsTable, List<Transaction>>
  _fromAccountTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.transactions,
    aliasName: $_aliasNameGenerator(
      db.accounts.id,
  ...
  static MultiTypedResultKey<$TransactionsTable, List<Transaction>>
  _toAccountTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.transactions,
    aliasName: $_aliasNameGenerator(
      db.accounts.id,
...
final class $$SubcategoriesTableReferences
  ...
  _recurringTransactionsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.subcategories.id,
          db.recurringTransactions.subcategoryId,
        ),
      );
