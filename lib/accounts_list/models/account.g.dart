...
void _accountSerialize(
  ...
  writer.writeBool(offsets[4], object.includeInTotal);
...
Account _accountDeserialize(
  ...
  final object = Account(
    ...
    currency: reader.readStringOrNull(offsets[2]) ?? 'USD',
    id: reader.readStringOrNull(offsets[3]) ?? '',
    includeInTotal: reader.readBoolOrNull(offsets[4]) ?? true,
    initialBalance: reader.readDoubleOrNull(offsets[5]) ?? 0,
...
extension AccountQueryFilter
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdEqualTo(
    String value, {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'categoryId',
        value: '',
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> categoryIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'categoryId',
        value: '',
